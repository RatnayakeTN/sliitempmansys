...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <%
			...
			ArrayList<PositionModel> list = (ArrayList<PositionModel>)request.getAttribute("ulx");
			     ...
			     <div class="col-lg-10">
			        <div class="p-5">
			          <div class="text-center"> 
				         ...
				         <form name = "editPosition" action ="UpdatePositionServlet" method ="post" onsubmit = "return updatePosition()">
				         	
				          
							  <div class="form-row d-flex justify-content-center">
							  	<div class="col-1">
							      <input type ="text" class="form-control" name="pid" value = "<%= my.getPid() %>" readonly>
							    </div>
							    <div class="col-5">
							      <input type="text" class="form-control"  name="NewPositionName" value = "<%= my.getPositionName() %>">
							    </div>
							    <div class="col-2">
							      <input type="text" class="form-control"  name="NewSalary" value = "<%= my.getBasicSalary() %>">
							    </div>
  ...
  <script src="Styles/js/validateUpdatedPosition.js"></script>
