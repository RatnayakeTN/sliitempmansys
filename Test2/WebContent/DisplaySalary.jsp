<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
     <%@ page import="model.Master_Salary" %>
<%@ page import="service.IMasterSalaryService" %>
<%@ page import="service.MasterSalaryServiceImpl"%>
<%@ page import="java.util.ArrayList"%>
<%@ page import="model.RegisterModel" %>
<%@ page import="service.IRegisterUser" %>
<%@ page import="service.RegisterUserServiceImpl"%>
...
<body id="page-top">
        ...
        <nav class="navbar navbar-expand topbar mb-4 static-top" style = "background-color: #212529">
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <input type="text" class="form-control bg-light border-0 small" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2" id ="search" onClick="javascript:go()">
        ...
        <div class="container-fluid">
			          ...
			          <div class="col-lg-5">
			            <div class="p-8">
			              <div class="text-center">
			                <h1 class="h4 text-gray-900 mb-4">ADD SALARY DETAILS</h1>
			              </div>
			              <form class="user" action = "InsertSalaryServlet" method ="post" name="addSalary" onsubmit="return validateSalary()">
			                ...
			                <div class="form-group">
							      <select id="Users" name="emp_id" class="form-control">
							      	<option disabled selected>--Select Employee--</option>
							      	
							   <%
							   		IRegisterUser serv = new RegisterUserServiceImpl();
								
									ArrayList<RegisterModel> list = serv.getUserDetails();
								
									for(RegisterModel p :list){
								
							    %>
							      	<option name="emp_id" hidden ><%=p.getUid() %></option>
							        <option value=<%=p.getUid() %> ><%=p.getUid()%> - <%=p.getFname()%> <%=p.getLname()%></option>
			                ...
			                <div class="form-group" >
			                  ...
			                  <input type="month" class="form-control form-control-user" name="month" >
			                </div>
			                <div class="form-group">
			                  <label>EPF Deductions</label>
			                  <input type="text" class="form-control form-control-user" name="epf_deductions" >
			                </div>
			                <div class="form-group">
			                  <label>Over Time</label>
			                  <input type="text" class="form-control form-control-user" name="OT" >
			                </div>
			                <div class="form-group">
			                  <label>Other Deductions</label>
			                  <input type="text" class="form-control form-control-user" name="deductions" >
			                </div>
			                <div class="form-group">
			                  <label>Net Salary</label>
			                  <input type="text" class="form-control form-control-user" name="net_salary" >
			                </div>
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group" style="background:white;">
              <input type="text" class="form-control bg-light border-0 small" placeholder="Search for..." aria-label="Search" aria-describedby="basic-addon2" id ="search1" onClick="javascript:go()">
              <div class="input-group-append">
                <button class="btn btn-primary" type="button">
                  <i class="fas fa-search fa-sm"></i>
                </button>
		  ...
		  <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Available Employee Salary Details</h1>
          </div>
         ...
         <tbody>
	      <%
			ISalaryService sals = new SalaryServiceImpl();
											
			ArrayList<Salary> list2 = sals.getSalary();
											
											
			for (Salary s:list2){ 
		  %>
			<tr>
				<td><%=s.getSalary_id()%></td>
				<td><%=s.getMonth()%></td>
				<td><%=s.getEmp_id()%></td>
				<td><%=s.getEpf_deductions()%></td>
				<td><%=s.getOT()%></td>
				<td><%=s.getDeductions()%></td>
				<td><%=s.getNet_salary()%></td>
				<td><%=s.getCreated_datetime()%></td>
				<td><%=s.getUpdated_datetime()%></td>
				<td>
											
				<div class = "btn-group" role="group">				
				<a class="dropdown-item" href="#" data-toggle="modal" data-target="#DeleteModal<%=s.getSalary_id()%>">
              	<input type="hidden" name="deleteSalary" value="<%=s.getSalary_id()%>">
				<button type="submit" class="btn btn-danger btn-circle"><i class="fas fa-trash"></i></button>
					 ...
					 <!-- Delete Modal-->
					  <div class="modal fade" id="DeleteModal<%=s.getSalary_id()%>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					    <div class="modal-dialog" role="document">
					      <div class="modal-content">
					        <div class="modal-header">
					          <h5 class="modal-title" id="exampleModalLabel">Delete Salary Info</h5>
					          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
					            <span aria-hidden="true">×</span>
					          </button>
					        </div>
					        <div class="modal-body">Are you sure you want to delete Salary Info?</div>
				...
				<form action="GetSalaryServlet" method="post">
											
						<input type="hidden" name="updateSalary" value="<%=s.getSalary_id()%>">
						<button type="submit" class="btn btn-info btn-circle""><i class="fas fa-info-circle"></i></button>
  ...
  <script src="Styles/js/validateSalary.js"></script>
