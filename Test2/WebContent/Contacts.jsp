			        ...
			        <div class="row justify-content-center">
			          <div class="col-lg-10">
			            <div class="p-5">
			              ...
			              <form class="user" action="addcontact.jsp" method="post">
			                <div class="form-group row">
			                  <div class="col-sm-6 mb-3 mb-sm-0">
			                    Email<input type="email" class="form-control form-control-user" name="email" >
			                  </div>
			                  <div class="col-sm-6">
			                    Name<input type="text" class="form-control form-control-user" name="name" >
			                  </div>
			                </div>
			                <div class="form-group">
			                  Designation<input type="text" class="form-control form-control-user" name="designation">
			                </div>
			                <div class="form-group">
			                    Company<input type="text" class="form-control form-control-user" name="company">
			                  </div>
			                ...
			                <input type="submit" value="Add Contact" class="btn btn-primary btn-user btn-block" id="button">
			                 <a href="ShowContacts.jsp" class="btn btn-info btn-user btn-block">View All Contacts</a>
			                <div>
