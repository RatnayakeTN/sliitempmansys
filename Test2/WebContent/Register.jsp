...
<body id="page-top">
			        ...
			        <div class="row justify-content-center">
			          <div class="col-lg-10">
			            <div class="p-5">
			              ...
			              <form name = "addNewUser" class="user" action = "AddNewUserServlet" method ="post" onsubmit="return validateReg()">
			                ...
			                <div class="form-group row">
			                  <div class="col-sm-6 mb-3 mb-sm-0">
			                    <input class="form-control form-control-user" name="ContactNo" placeholder="Contact Number">
			                  </div>
			                  <div class="col-sm-6">
			                    <input class="form-control form-control-user" name="UserName" placeholder="User Name">
			                  </div>
			                </div>
			                <div class="form-group row">
			                  <div class="col-sm-6 mb-3 mb-sm-0">
			                  ...
			                  <div class="col-sm-6">
			                    <input type="password" class="form-control form-control-user" name="RepeatPassword" placeholder="Confirm Password">
			                  </div>
			                </div>
			                <div class="form-group">
			                  <input class="form-control form-control-user" name="Address" placeholder="Address">
			                </div>
			                ...
			                <div class="col-sm-6 mb-3 mb-sm-0">
							      <select id="Positions" name="Position" class="form-control">
							   ...
							   <%
							    ...
							    %>
							        ...
							        <option ><%=my.getPositionName() %></option>
						      ...
						      <select id="UserLevel" name="UserLevel" class="form-control">
							   ...
							   <%
							    	IUserLevel serv2 = new UserLevelServiceImpl();
									
									ArrayList<UserLevelModel> list2 = serv2.getAllUserLevels();
									
									for(UserLevelModel my :list2){
								
							    %>
							      	
							        <option ><%=my.getUlevel() %>  - User level <%=my.getNo() %></option>
			                ...
			                <div>
			                	<button type="submit" class="btn btn-primary btn-user btn-block" >Move On</button>
			                </div>
			                <hr>
			              </form>
  ...
  <script src="Styles/js/validateRegisterForm.js"></script>
  <script src="Styles/js/validateRegister2.js"></script>
