...
<%@page import="com.handlers.ContactDao,model.Contact,java.util.*"%>  
			          ...
			          <div class="col-lg-10">
			            <div class="p-5">
			              <div class="text-center">
			                <h1 class="h4 text-gray-900 mb-4">SHOW CONTACTS</h1>
			              </div>
			              <%  
							List<Contact> list=ContactDao.getAllRecords();  
			             ...
			             <table class="table table-hover">
			             	...
			             	<tr>
			           		...
			           		<tbody>
			           			<c:forEach items="${list}" var="u">  
									...
									<td>${u.getCompany()}</td>
									<td>${u.getCategory()}</td>  
									<td><a href="EditContacts.jsp?id=${u.getId()}" class="btn btn-success">Edit</a></td>  
									<td><a href="deletecontact.jsp?id=${u.getId()}" class="btn btn-danger">Delete</a></td>
									</tr>  
								</c:forEach>  
			              ...
			              <br/><a href="Contacts.jsp" class="btn btn-primary">Add New Contact</a>  
			               <hr>
			               <hr>
