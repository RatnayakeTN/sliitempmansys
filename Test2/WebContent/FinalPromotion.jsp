...
<body id="page-top">
  ...
  <div id="wrapper">
	...
	<div class="container">
			          ...
			          <div class="col-lg-10">
			            <div class="p-5">
			              <div class="text-center">
			                <h1 class="h4 text-gray-900 mb-4">Add promotion</h1>
			              </div>
			              ...
			              <form class="user" action="AddPromotion" method="POST" onsubmit="return validate(this);">
			                ...
			                <div class="form-group">
			                  ...
			                  <input type="text" class="form-control form-control-user" name="applicant" placeholder="Applicant..">
			                </div>
			                
			                <div class="form-group">
			                	<label>Approved by</label>
			                  <input type="text" class="form-control form-control-user" name="approved_by" placeholder="Approved by..">
			                </div>
			                ...
			                <button type="submit" class="btn btn-primary btn-user btn-block">Add Promotion</button>
		...
		<%
			PromotionService promo= new PromotionServiceImpl();
			ArrayList<Promotion> list2= promo.getAllPromotions();
	 
			for(Promotion promotion:list2){
				if(promotion.isStatus()){
		%>
			<tr>
			    <td><%=promotion.getProm_id()%></td>
				<td><%=promotion.getApplicant()%></td>
				<td><%=promotion.getApproved_by()%></td>
				<td><%=promotion.getDesignation()%></td>
				<td><%=promotion.getStat_date()%></td>
				<td><%=promotion.getDescription()%></td>
				<td>
				<form action="DeleteEventServlet" method="post">
					<input type="hidden" name="deleteValue" value="<%=promotion.getProm_id() %>">						
					<button type="submit" class="btn btn-danger" name="deleteBtn" value="Delete"> Delete</button>
				</form> 
				<td>
			</tr>
		<%	
  ...
  <script src="Styles/js/validationPromotion.js"></script>
