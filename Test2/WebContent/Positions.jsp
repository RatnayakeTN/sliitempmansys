...
<%@ page import="model.PositionModel" %>
<%@ page import="service.IPosition" %>
<%@ page import="service.PositionServiceImpl"%>
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add New Position</h1>
          </div>
          
          
          
           <form name = "addNewPosition" action = "AddNewPositionServlet" method ="post" onsubmit = "return validatePosition()">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Available Positions</h1>
          </div>
		...
		<table class="table table-hover " id="table">
		  <thead class="thead-dark">
		    <tr>
		      ...
		      <th scope="col" style="width: 30%">Basic Salary</th>
		    </tr>
		  </thead>
		  
		    <%
		    IPosition serv = new PositionServiceImpl();
				
				ArrayList<PositionModel> list = serv.getAllPositions();
				
				for(PositionModel my :list){
			
		    %>
		    
			    <tr>
			    	<td><%=my.getPid() %></td>
				 	<td><%=my.getPositionName() %></td>
					<td><%=my.getBasicSalary() %></td>
					<td>
						
						<div class="btn-group" role="group" aria-label="Basic example">
					
						<form action = "EditUserPositionServlet" method = "post">						
							<a href=""  class="btn btn-info btn-icon-split" >
							<input type = "hidden" name ="edit" value = "<%=my.getPid()%>">
						...
						<a class="btn btn-danger btn-icon-split" href="#" data-toggle="modal" data-target="#DeleteModal<%=my.getPid()%>">
							<input type = "hidden" name ="delete" value = "<%=my.getPid()%>">
								<span class="icon text-white-50">
					...
					<!-- Delete Modal-->
					  <div class="modal fade" id="DeleteModal<%=my.getPid()%>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					    <div class="modal-dialog" role="document">
					      <div class="modal-content">
					        <div class="modal-header">
					          <h5 class="modal-title" id="exampleModalLabel">Delete Position Details</h5>
					          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
					            <span aria-hidden="true">×</span>
					          </button>
					        </div>
					        <div class="modal-body">Are you sure you want to delete Position Details?</div>
  ...
  <script src="Styles/js/validatePosition.js"></script>
