...
function validatemanualForm() {
  var p = document.forms["ManualUpdateLeave"]["from_date"].value;
  var q = document.forms["ManualUpdateLeave"]["to_date"].value;
  var r = document.forms["ManualUpdateLeave"]["from_time"].value;
  var s = document.forms["ManualUpdateLeave"]["To_time"].value;
  if (p >= q ) {
...
<body id="page-top">
			          ...
			          <div class="col-lg-8">
			            <div class="p-5">
			              <div class="text-center">
			                <h1 class="h4 text-gray-900 mb-4">Manual Leave Form</h1>
			              </div>
          
          
          
				         <form class="user" name="ApplyLeaves" action="ManualUpdateLeave"  onsubmit="return validateForm()"  method="post">
							                  ...
							                  <style>
							                   #userLevel{
					  								...
					  								Employee ID :
					  							<div class="form-group">
							                  <input type="text" class="form-control form-control-user" name ="emp_id" placeholder="emp_id" required>
							                	</div> 
				
				     								Leave Type :
							                  
							                  <div class="form-group">
										      <select id="userLevel" class="form-control" name="Leave_type" >
				    							...
				    							<option value="other">Other</option>
				      								...
				      								Requested From :
				    						 <div class="form-group">
							                  <input type="date" class="form-control form-control-user" name ="from_date" placeholder="From date" required>
							                </div>
							                		To :
							                <div class="form-group">
							                  <input type="date" class="form-control form-control-user" name ="to_date" placeholder="To date">
							                </div>
							                		Requsested Time :
							                 <div class="form-group">
							                  <input type="time" class="form-control form-control-user" name ="from_time" placeholder="From Time" required>
							                </div>
							                		To :
				      						<div class="form-group">
							                  <input type="time" class="form-control form-control-user" name ="To_time" placeholder="To Time" required>
							                </div>
				      						
				      								Reason :
				     
				      						<div class="form-group">
							                  <input type="text" class="form-control form-control-user" name ="reason" placeholder="Reason" required>
							                </div>
				         
				      
				     						 <button type ="Submit" class="btn btn-primary btn-user btn-block">Apply</button>
  ...
  <script src="Styles/js/Leave.js"></script>
</body>
</html>