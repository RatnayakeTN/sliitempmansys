...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add New Basic Salary Details</h1>
          </div>
             ...
             <form name = "addBasicSalaryInfo" action = "InsertSalaryInfoAdminServlet" method ="post" onsubmit = "return validate()">
			  ...
			  <div class="form-row d-flex justify-content-center">
			    ...
			    <div class="col-5">
			                ...
			                <div class="form-row d-flex justify-content-center">
							      <select id="Users" name="employeeid" class="form-control">
							      	<option disabled selected>--Select Employee--</option>
							      	
							   <%
							   		IRegisterUser serv = new RegisterUserServiceImpl();
								
									ArrayList<RegisterModel> list1 = serv.getUserDetails();
								
									for(RegisterModel p :list1){
								
							    %>
							      	<option name="employeeid" hidden ><%=p.getUid() %></option>
			    ...
			    <div class="col-2">
			      <input type="text" class="form-control"  name="basicsalary" placeholder="Basic Salary">
			    </div>
			    <div class="col-2">
			      <input type="text" class="form-control"  name="allowances" placeholder="Allowances">
			    </div>
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Available Basic Salary Details</h1>
          </div>
		...
		<table class="table table-hover " id="table">
         ...
         <tbody>
	      <%
			IMasterSalaryService sals = new MasterSalaryServiceImpl();
											
			ArrayList<Master_Salary> list = sals.getSalary();
											
											
			for (Master_Salary m:list){ 
		  %>
				<tr>
				<td><%=m.getEmp_id() %></td>
				<td><%=m.getBasic_salary() %></td>
				<td><%=m.getAllowances() %></td>
				<td><%=m.getCreated_date() %></td>
				<td><%=m.getUpdated_datetime() %></td>
				<td>
											
		
			
						<div class = "btn-group" role="group">				
						<a class="dropdown-item" href="#" data-toggle="modal" data-target="#DeleteModal<%=m.getTable_id()%>">
              			<input type="hidden" name="deleteSalary" value="<%=m.getTable_id()%>">
					 ...
					 <!-- Delete Modal-->
					  <div class="modal fade" id="DeleteModal<%=m.getTable_id()%>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					    <div class="modal-dialog" role="document">
					      <div class="modal-content">
					        ...
					        <form action="DeleteSalaryInfoServlet" method="post">
					          <input type="hidden" name="deleteSalary" value="<%=m.getTable_id()%>">
				...
				<form action="GetSalaryInfoServlet" method="post">
											
						
              			<input type="hidden" name="updateSalary" value="<%=m.getTable_id()%>">
  ...
  <script src="Styles/js/validateSalaryInfo.js"></script>
