		  ...
		  <thead class="thead-dark">
		    ...
		    %>
			    ...
			    <tr>
					...
					<td><%=my.getLname() %></td>
					<td><%=my.getEmail() %></td>
				 	<td><%=my.getContactNo() %></td>
					<td><%=my.getAddrerss() %></td>
					<td><%=my.getPosition() %></td>
				 	<td><%=my.getUserLevel() %></td>
					<td>
						<form action = "#" method = "post">
						<a class="btn btn-danger btn-icon-split" href="#" data-toggle="modal" data-target="#DeleteModal<%=my.getUid() %>">
							<input type = "hidden" name ="delete" value = "<%=my.getUid() %>">
						...
						<!-- Delete Modal-->
					  <div class="modal fade" id="DeleteModal<%=my.getUid() %>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					    <div class="modal-dialog" role="document">
					      <div class="modal-content">
					        ...
					        <div class="modal-body">Are you sure you want to delete User Details?</div>
