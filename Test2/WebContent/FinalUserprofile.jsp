...
<%@page import="service.PromotionServiceImpl"%>
			        ...
			        <div class="row justify-content-center">
			          <div class="col-lg-10">
			            <div class="p-5">
			              ...
			              <%
			EmployeeService serv1= new EmployeeServiceImpl();
			ArrayList<Employee> ls= serv1.getAllEmployees();
	 
			for(Employee ev:ls){
				if(ev.getState()!=1){
		%>
			              
			              <form class="user" action="AddPromotion" method="POST" onsubmit="return validate(this);">
			              
			                <div class="form-group">
			                	<label>User Id</label>
			                  <input type="text" class="form-control form-control-user" value = " <%= ev.getUser_id() %> " name="userId" disabled >
			                </div>
			                
			                <div class="form-group">
			                	<label>First Name </label>
			                  <input type="text" class="form-control form-control-user" value = " <%= ev.getFirst_name() %> "  name="approved_by" disabled >
			                </div>
			                
			                <div class="form-group">
			                	<label>Last Name</label>
			                  <input type="text" class="form-control form-control-user" value = " <%= ev.getLast_name() %> "  name="designation" disabled>
			                </div>
			                
			                <div class="form-group">
			                	<label>Profession</label>
			                  <input type= "text" class="form-control form-control-user" value = " <%= ev.getUser_id() %> "  name="date" disabled>
			                </div>
			                
			                </form>
			                <form class="user" action="EditEmpServlet" method="POST" onsubmit="return validate(this);">
			                <div class="form-group">
			                	<label>Address</label>
			                	<input type="hidden" name="userId" value="<%=ev.getUser_id() %>" required>
								<input type="hidden" name="field" value="address">	
			                  <input type="text" class="form-control form-control-user" value="<%=ev.getAddress() %>" name="edit">
					<input type="submit" name="EditBtn" value="Edit"> 
			                ...
			                <form class="user" action="EditEmpServlet" method="POST" onsubmit="return validate(this);">
			                 <div class="form-group">
			                  ...
			                  <input type="text" class="form-control form-control-user" value="<%=ev.getContact_no() %>"  name="edit">
					<input type="submit" name="EditBtn" value="Edit"> 
			                </div>
			                </form>
			                <form class="user" action="EditEmpServlet" method="POST" onsubmit="return validate(this);">
			                <div class="form-group">
			                  ...
			                  <input type="text" class="form-control form-control-user" value="<%=ev.getEmail() %>"  name="edit">
					<input type="submit" name="EditBtn" value="Edit"> 
