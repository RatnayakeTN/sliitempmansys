...
<%@page import="com.handlers.ContactDao,model.Contact"%>
	<%  
	String id=request.getParameter("id");  
	Contact u=ContactDao.getRecordById(Integer.parseInt(id));  
	%>  
			        ...
			        <div class="row justify-content-center">
			          <div class="col-lg-10">
			            <div class="p-5">
			              ...
			              <form class="user" action="editcontact.jsp" method="post">
			              <input type="hidden" name="id" value="<%=u.getId() %>"/>  
			                <div class="form-group row">
			                  <div class="col-sm-6 mb-3 mb-sm-0">
			                    Email<input type="email" value="<%= u.getEmail()%>" class="form-control form-control-user" name="email" >
			                  </div>
			                  <div class="col-sm-6">
			                    Name<input type="text"  value="<%= u.getName()%>" class="form-control form-control-user" name="name" >
			                  </div>
			                </div>
			                <div class="form-group">
			                  Designation<input type="text" value="<%= u.getDesignation()%>" class="form-control form-control-user" name="designation">
			                </div>
			                <div class="form-group">
			                    Company<input type="text" value="<%= u.getCompany()%>" class="form-control form-control-user" name="company">
			                  </div>
			                ...
			                <input type="submit" value="Edit Contact" class="btn btn-primary btn-user btn-block" id="button">
			                <div>
