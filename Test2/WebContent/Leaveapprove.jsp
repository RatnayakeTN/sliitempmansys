<%@page import="model.LeaveInfo"%>
<%@page import="java.util.ArrayList"%>
<%@page import="service.LeaveServieImpl"%>
...
<body id="page-top">
  ...
  <tbody>
  <%
	LeaveService service = new LeaveServieImpl();

	ArrayList<LeaveInfo> list =  service.getAllLeaves();
	for(LeaveInfo lve:list){
		
	
%>
<tr>
	
	<td align="center"><%=lve.getEmp_id() %></td>
	<td align="center"><%=lve.getLeave_type() %></td>
	<td align="center"><%=lve.getRequested_date() %></td>
	<td align="center"><%=lve.getTo_date() %></td>
	<td align="center"><%=lve.getFrom_time() %></td>
	<td align="center"><%=lve.getTo_time() %></td>
	<td align="center"><%=lve.getReason() %></td>
	<td align="center"></td>
	<td align="center">
	
		<div class="btn-group" role="group" aria-label="Basic example">
		
			<form action="ApprovedLeaves" method="post">
				<input type ="hidden" name="Leave_id" value="<%= lve.getLeave_id() %>">
				<button type = "submit" class="btn btn-primary" value="pprove">Approve</button>
			</form>
			
			<form action="RejectLeaves" method="post">
				<input type ="hidden" name="Leave_idx" value=<%= lve.getLeave_id() %>>
				
				<button type = "submit" class="btn btn-danger" value="preject">Reject</button>
			</form>
