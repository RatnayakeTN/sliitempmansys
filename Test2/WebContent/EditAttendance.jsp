    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <%
	ArrayList<AttendanceInfo> list = (ArrayList<AttendanceInfo>)request.getAttribute("attendance");
for(AttendanceInfo atten: list){
	%>
<form name = "addNewRec" class="user" method = "post" action = "UpdateAttendanceServlet" onsubmit="return validate()">
<input type = "hidden" value = "<%= atten.getAttId() %>" name = "AttenId">
<div class="form-group">
<label>User</label>
<div class="col-sm-10"><input type = "text" class="form-control form-control-user"  name = "user" value = "<%= atten.getCreatedBy() %>"></div>
</div>
<div class="form-group">
<label>Employee ID </label>
<div class="col-sm-10"><input type = "text" class="form-control form-control-user"   name = "empId" value = "<%= atten.getEmpId() %>"></div>
</div>
<div class="form-group">
<label>Date</label>
<div class="col-sm-10"><input type = "date" class="form-control form-control-user"   name = "date" value = "<%= atten.getDate() %>"></div>
</div>
<div class="form-group">
<label>In Time </label>
<div class="col-sm-10"><input type = "time" class="form-control form-control-user"   name = "inTime" value = "<%= atten.getInTime() %>"></div>
</div>
<div class="form-group">
<label>Out Time </label>
<div class="col-sm-10"><input type = "time" class="form-control form-control-user"   name = "outTime" value = "<%= atten.getOutTime() %>"></div>
</div>
