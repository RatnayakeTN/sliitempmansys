      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <style type="text/css">
			.bgimg {
    			background-image: url('Styles/images/p2.jpg');
					}
			</style>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action = "ValidateUserLoginServlet" method ="post">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="InputUserName" aria-describedby="emailHelp" placeholder="Enter User Name...">
                    </div>
                    <div class="form-group">
