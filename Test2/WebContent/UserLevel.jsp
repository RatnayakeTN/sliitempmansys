...
<%@ page import="model.UserLevelModel" %>
<%@ page import="service.IUserLevel" %>
<%@ page import="service.UserLevelServiceImpl"%>
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add New User Level</h1>
          </div>
          
          <form name = "addNewUserLevel" action = "AddUserLevelServlet" method ="post" onsubmit = "return validateUserLevel()">
          
			  <div class="form-row d-flex justify-content-center">
			    <div class="col-5">
			      <input type="text" class="form-control"  name="Ulevel" placeholder="User Level">
			    </div>
			    <div class="col-2">
			      <input type="text" class="form-control"  name="No" placeholder="Number">
			    </div>
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Available User Levels</h1>
          </div>
		...
		<table class="table table-hover " id="table">
		  <thead class="thead-dark">
		    <tr>
		      <th scope="col" style="width: 50%">User Level</th>
		      <th scope="col" style="width: 30%">User Level Number</th>
		    </tr>
		  </thead>
		  
		    <%
		    	IUserLevel serv = new UserLevelServiceImpl();
				
				ArrayList<UserLevelModel> list = serv.getAllUserLevels();
				
				for(UserLevelModel my :list){
		    ...
		    %>
			    ...
			    <tr>
					...
					<div class="btn-group" role="group" aria-label="Basic example">
						...
						<form action = "EditUserLevelServlet" method = "post">						
							<a href=""  class="btn btn-info btn-icon-split">
							<input type = "hidden" name ="edit" value = "<%=my.getNo()%>">
						...
						<a class="btn btn-danger btn-icon-split" href="#" data-toggle="modal" data-target="#DeleteModal<%=my.getNo()%>">
							<input type = "hidden" name ="delete" value = "<%=my.getNo()%>">
								<span class="icon text-white-50">
						...
						<!-- Delete Modal-->
					  <div class="modal fade" id="DeleteModal<%=my.getNo()%>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					    <div class="modal-dialog" role="document">
					      <div class="modal-content">
					        <div class="modal-header">
					          <h5 class="modal-title" id="exampleModalLabel">Delete User Level</h5>
					          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
					            <span aria-hidden="true">×</span>
					          </button>
					        </div>
					        <div class="modal-body">Are you sure you want to delete User Level Details?</div>
					        <div class="modal-footer">
					        <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
					        <form action="DeleteUserLevelServlet" method="post">
					          <input type="hidden" name="delete" value="<%=my.getNo() %>">
  ...
  <script src="Styles/js/validateUserLevel.js"></script>
