...
<meta charset="ISO-8859-1">
  ...
  <title>Update Salary Info</title>
...
<body id="page-top">
             ...
             <div class="container" style="width:80%; align:right;">
			    ...
			    <div class="card o-hidden border-0 shadow-lg my-0">
			      ...
			      <div class="text-center">
			                <h1 class="h4 text-gray-900 mb-4">UPDATE BASIC SALARY DETAILS</h1>
			              </div>
			
			    
			    
			     <form action = "UpdateSalaryInfoServlet" method ="post" class="user" name="updateBasicSalaryInfo" onsubmit="return validate()">
			               
			               <%
								ArrayList<Master_Salary> list1 = (ArrayList<Master_Salary>)request.getAttribute("salary");
								for(Master_Salary m: list1){
							%>
			                <div class="form-group">
			                  <label>Employee</label>
			     			  <input type="text" class="form-control form-control-user"  name="employeeid" value="<%=m.getEmp_id()%>" readonly>
			     			</div>
			                <div class="form-group">
			                  <label>Basic Salary</label>
			     			  <input type="text" class="form-control form-control-user"  name="basicsalary" value="<%=m.getBasic_salary()%>" >
			     			</div>
			                <div class="form-group">
			                  <label>Allowances</label>
			      			<input type="text" class="form-control form-control-user"  name="allowances" value="<%=m.getAllowances()%>" >
			   				 </div>
							<br>
							<div class="form-group" align="center">
			    
			     	<a href="#" class="btn btn-success btn-icon-split">
			 	  	<button class="btn btn-success btn-icon-split" style="align:center;" value="<%=m.getTable_id()%>" name="tableid">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">  Update  Details</span></button>
                  </a>
  ...
  <script src="Styles/js/updateSalaryInfo.js"></script>
