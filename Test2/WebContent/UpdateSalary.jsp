             ...
             <div class="container" style="width:80%; align:right;">
			    ...
			    <div class="card o-hidden border-0 shadow-lg my-0">
			      ...
			      <div class="text-center">
			                <h1 class="h4 text-gray-900 mb-4">UPDATE SALARY DETAILS</h1>
			              </div>
           <form action = "UpdateSalaryServlet" method ="post" class="user" name="addSalary" onsubmit="return validateSalary()">
           
           
			<%
				ArrayList<Salary> list = (ArrayList<Salary>)request.getAttribute("salary");
				for(Salary m: list){
			%>
			  ...
			  <div class="form-row d-flex justify-content-center">
			      ...
			      <input type="text" class="form-control"  name="salary_id" value="<%=m.getSalary_id()%>" readonly><br>
			    </div><br>
			    <div class="col-8">
			      <label>Employee</label>
			      <input type="text" class="form-control"  name="emp_id" value="<%=m.getEmp_id()%>" readonly><br>
			    </div><br>
			    <div class="col-8">
			      <label>Month</label>
			      <input type="text" class="form-control"  name="month" value="<%=m.getMonth()%>" >
			    </div><br><br><br><br>
			    <div class="col-8">
			      <label>Epf Deductions</label>
			      <input type="text" class="form-control"  name="epf_deductions" value="<%=m.getEpf_deductions()%>" ><br>
			    </div><br>
			    <div class="col-8">
			      <label>Over Time</label>
			      <input type="text" class="form-control"  name="OT" value="<%=m.getOT()%>" ><br>
			    </div><br>
			    <div class="col-8">
			      <label>Deductions</label>
			      <input type="text" class="form-control"  name="deductions" value="<%=m.getDeductions()%>" ><br>
			    </div><br>
			    <div class="col-8">
			      <label>Net Salary</label>
			      <input type="text" class="form-control"  name="net_salary" value="<%=m.getNet_salary()%>" required>
			    </div><br><br><br><br>
			    <div class="col-8" align="center">
			    
			     	<a href="#" class="btn btn-success btn-icon-split">
			 	  	<button class="btn btn-success btn-icon-split" style="align:center;" value="<%=m.getSalary_id()%>" name="salary_id">
