...
<%@page import="com.handlers.EmailReciever,model.Email,model.User,java.util.*"%>  
...
<!-- using Ajax -->
  ...
  <link href="Styles/css/tr.css" rel="stylesheet">
			          ...
			          <div class="col-lg-10">
			            <div class="p-5">
			              <div class="text-center">
			                <h1 class="h4 text-gray-900 mb-4">MAIN</h1>
			              </div>
			               <%  
			               		List<Email> list=(ArrayList<Email>)request.getAttribute("list");
						  %>  
						  
						 <a href="Contacts.jsp" class="btn " >Add New Contact</a>
						 <a href="ShowContacts.jsp" class="btn" >Contacts</a> 
						<a href="LoginEmail.jsp" class="btn"><i class="fa fa-folder"></i>Archive</a>
						<a href="LoginEmail.jsp" class="btn"><i class="fa fa-close"></i>Close</a>
