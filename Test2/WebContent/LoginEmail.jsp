			          ...
			          <div class="col-lg-10">
			            <div class="p-5">
			              <div class="text-center">
			                <h1 class="h4 text-gray-900 mb-4">ACCESS MAIL</h1>
			              </div>
			              <form class="user"  name="emailform" method="post" action="UserServlet" >
			                <div class="form-group row">
			                 
			                </div>
			                <div class="form-group">
			                  Email<input type="email" class="form-control form-control-user"  name="email" required>
			                </div>
			                <div class="form-group row">
			                ...
			                <div class="text-center">
			               	<input type="submit" value="ACCESS" class="btn btn-success btn-lg" style="width: 200px;">
			              </div>
			                <hr>
			              </form>
			              <hr>
