...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <%
			...
			ArrayList<UserLevelModel> list = (ArrayList<UserLevelModel>)request.getAttribute("ulx");
			     ...
			     <div class="col-lg-10">
			        <div class="p-5">
			          <div class="text-center"> 
				         ...
				         <form name="editUserlevel" action = "UpdateUserLevelServlet" method ="post" onsubmit = "return updateUserLevel()">
				          
							  <div class="form-row d-flex justify-content-center">
							    <div class="col-5">
							      <input type="text" class="form-control"  name="NewUlevel" value = "<%= my.getUlevel() %>">
							    </div>
							    <div class="col-2">
							      <input type="text" class="form-control"  name="NewNo" value = "<%= my.getNo() %>">
							    </div>
  ...
  <script src="Styles/js/validateUpdatedUserLevel.js"></script>
