<%@page import="model.AttendanceInfo"%>
<%@page import="java.util.ArrayList"%>
<%@page import="service.AttenServiceImpl"%>
<%@page import="service.AttenService"%>
...
<meta charset="ISO-8859-1">
  ...
  <title>Add Attendance Records</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style = "background-color: #212529">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="FrontPage.jsp">
        ...
        <div class="sidebar-brand-text mx-3">Procons Infotech</sup></div>
      </a>
				          ...
				          <div class="card-body p-0">
				            ...
				            <div class="row">
				              ...
				              <div class="p-5">
									...
									<h1 class="h3 mb-2 text-gray-800">Add Attendance Records Manually</h1><br><br>
									<form name = "addNewRec" class="user" method = "post" action = "ManualAddAttenServlet" onsubmit="return validate()">
									
									<div class="form-group">
									<label>user</label>
									<div class="col-sm-10">
									<input class="form-control form-control-user" type = "text" name = "user">
									</div>
									</div>
									...
									<div class="col-sm-10">
									<input class="form-control form-control-user" type = "text" name = "empId">
									</div>
									</div>
									...
									<label>In Time </label>
									<div class="col-sm-10">
									<input class="form-control form-control-user" type = "time" name = "inTime">
									</div>
									</div>
									...
									<div class="col-sm-10">
									<input class="form-control form-control-user" type = "time" name = "outTime">
									</div>
									</div>
				              ...
				              <div class="col-lg-5">
				                <div class="p-5">
				                  ...
				                  <h1 class="h3 mb-2 text-gray-800">Upload Attendance Sheet</h1><br><br>
...
<form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
            <div class="input-group">
              <input type="text" class="form-control bg-light border-0 small" placeholder="Search tables..." aria-label="Search" aria-describedby="basic-addon2" id ="search1" onClick="javascript:go()">
              <div class="input-group-append">
                <button class="btn btn-primary" type="button">
                  <i class="fas fa-search fa-sm"></i>
                </button>
...
<table class="table table-bordered" id="table" width="100%" cellspacing="0">
		...
		<%
			AttenService serv= new AttenServiceImpl();
			ArrayList<AttendanceInfo> list= serv.getAllAttenRecords();
	 
			for(AttendanceInfo evt:list){
		%>
			<tr>
				<td align="center"><%=evt.getEmpId()%></td>
				<td align="center"><%=evt.getCreatedBy()%></td>
				<td align="center"><%=evt.getDate()%> </td>
				<td align="center"><%=evt.getInTime()%> </td>
				<td align="center"><%=evt.getOutTime()%> </td>
				<td align="center"><%=evt.getHoursWorked()%> </td>
				<td align="center">
				<div style="width: 50%; float: left;"><form action="DeleteEventServlet" method="post">
					<input type="hidden" name="AttenId" value="<%=evt.getAttId()%>">	
					<button type="submit" onclick="return confirm('Are you sure?')" class="btn-circle bg-gradient-danger btn-sm"><i class="fa fa-minus-circle" aria-hidden="true"></i></button>
				</form></div>
				<div style="width: 50%; float: left;"><form action="EditRecordServlet" method="post">
					<input type="hidden" name="AttenId" value="<%=evt.getAttId()%>">	
					<button type="submit" class="btn-circle bg-gradient-warning btn-sm"><i class="fa fa-cog" aria-hidden="true"></i></button>
				</form></div>
				<td>
			</tr>
  ...
  <script src="Styles/js/demo/chart-pie-demo.js"></script>
    <script src="Styles/js/attendance.js"></script>
