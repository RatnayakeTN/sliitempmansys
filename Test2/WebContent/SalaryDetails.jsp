...
<meta charset="ISO-8859-1">
  ...
  <title>Add Basic Salary Details</title>
			          ...
			          <div class="col-lg-8">
			            <div class="p-5">
			              <div class="text-center">
			                <h1 class="h4 text-gray-900 mb-4">ADD BASIC SALARY DETAILS</h1>
			              </div>
			              <form class="user" action = "InsertSalaryInfoServlet" method ="post" name="addBasicSalaryInfo" onsubmit="return validate()">
			                ...
			                <div class="form-group">
			                  <input type="text" class="form-control form-control-user" name="basicsalary" placeholder="Basic Salary" >
			                </div>
			                <div class="form-group">
			                  <input type="text" class="form-control form-control-user" name="allowances" placeholder="Allowances" >
			                </div>
			        
			                <button type="submit" class="btn btn-primary btn-user btn-block" >Finish Up</button>
