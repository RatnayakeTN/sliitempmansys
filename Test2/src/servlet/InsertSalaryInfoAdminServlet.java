...
/**
 * Servlet implementation class InsertSalaryInfoAdminServlet
 */
@WebServlet("/InsertSalaryInfoAdminServlet")
public class InsertSalaryInfoAdminServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsertSalaryInfoAdminServlet() {
        super();
